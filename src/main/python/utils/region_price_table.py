...
# ────────────────────────────────────────────────
# 行政區 → 縣市對照表（XGBoost Demo 模式回退用）
# 注意：東/北/南/西區在多縣市重複，優先對應最大城市
# ────────────────────────────────────────────────
DISTRICT_TO_REGION: dict[str, str] = {
    ...
    "樹林區": "新北市", "淡水區": "新北市", "汐止區": "新北市", "瑞芳區": "新北市",
    "三峽區": "新北市", "鶯歌區": "新北市", "泰山區": "新北市",
    # 桃園市
    "桃園區": "桃園市", "中壢區": "桃園市", "平鎮區": "桃園市", "八德區": "桃園市",
    "楊梅區": "桃園市", "蘆竹區": "桃園市", "龜山區": "桃園市", "大溪區": "桃園市",
    "觀音區": "桃園市", "大園區": "桃園市",
    # 台中市
    "北屯區": "台中市", "西屯區": "台中市", "南屯區": "台中市",
    "太平區": "台中市", "大里區": "台中市", "豐原區": "台中市",
    "烏日區": "台中市", "大甲區": "台中市",
    # 台南市
    "安平區": "台南市", "仁德區": "台南市", "永康區": "台南市", "安南區": "台南市",
    "歸仁區": "台南市",
    # 高雄市
    "前金區": "高雄市", "苓雅區": "高雄市", "三民區": "高雄市", "鼓山區": "高雄市",
    "左營區": "高雄市", "楠梓區": "高雄市", "鳳山區": "高雄市", "前鎮區": "高雄市",
    "小港區": "高雄市", "仁武區": "高雄市", "岡山區": "高雄市",
    # 新竹市
    "香山區": "新竹市",
    # 新竹縣
    "竹北市": "新竹縣", "竹東鎮": "新竹縣",
    # 基隆市
    "中正區": "基隆市",   # 注意：與台北市中正區同名，以最後 update 為準
}

# 行政區相對縣市基準單價的調整乘數
DISTRICT_PRICE_MULTIPLIER: dict[str, float] = {
    # 台北市（縣市基準 160 萬/坪）
    "中正區": 1.15, "大同區": 0.92, "中山區": 1.20, "松山區": 1.25,
    "大安區": 1.35, "萬華區": 0.82, "信義區": 1.42, "士林區": 1.05,
    "北投區": 0.90, "內湖區": 0.95, "南港區": 1.00, "文山區": 0.85,
    # 新北市（縣市基準 65 萬/坪）
    "板橋區": 1.12, "三重區": 0.90, "中和區": 0.95, "永和區": 1.08,
    "新莊區": 0.88, "新店區": 1.02, "土城區": 0.85, "蘆洲區": 0.88,
    "樹林區": 0.80, "淡水區": 0.85, "汐止區": 0.82,
    # 桃園市（縣市基準 35 萬/坪）
    "桃園區": 1.00, "中壢區": 1.05, "平鎮區": 0.90, "八德區": 0.95,
    "楊梅區": 0.85, "蘆竹區": 1.00, "龜山區": 0.95,
    # 台中市（縣市基準 42 萬/坪）
    "北屯區": 0.95, "西屯區": 1.12, "南屯區": 1.05,
    "太平區": 0.80, "大里區": 0.82, "豐原區": 0.90,
    # 高雄市（縣市基準 28 萬/坪）
    "前金區": 1.05, "苓雅區": 1.12, "三民區": 0.95, "鼓山區": 1.00,
    "左營區": 1.02, "楠梓區": 0.85, "鳳山區": 0.90,
}
